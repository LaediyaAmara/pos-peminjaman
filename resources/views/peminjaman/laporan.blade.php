...
{{-- Filter Laporan --}}
<div class="mb-8 bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 print:hidden">
    <form action="{{ route('peminjaman.laporan') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        <div>
    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- 1. WIDGET STATISTIK (Ini yang bikin informatif) --}}
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 print:hidden">
                ...
                <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    ...
                    <div class="text-2xl font-black text-rose-600">Rp {{ number_format($peminjamans->sum('denda.JumlahDenda')) }}</div>
                </div>
            </div>
