<x-app-layout>
    <div class="mb-8">
        <h3 class="text-3xl font-black text-gray-900 tracking-tight">👥 Manajemen Member</h3>
        <p class="text-gray-500">Daftar siswa yang terdaftar sebagai anggota perpustakaan.</p>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="text-[10px] font-black text-indigo-500 uppercase tracking-widest border-b border-indigo-50">
                            ...
                            <th class="px-6 py-5">Email & Username</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <div class="text-sm text-gray-600 font-medium">{{ $m->email }}</div>
                                <div class="text-[10px] text-gray-400 font-black uppercase tracking-tighter">{{ $m->Username }}</div>
                            </td>
                            <td class="px-6 py-5 text-sm text-gray-500 italic">
                                {{ $m->Alamat ?? 'Alamat belum diinput' }}
                            </td>
                            <td class="px-6 py-5">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 font-medium">Belum ada member yang terdaftar.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
